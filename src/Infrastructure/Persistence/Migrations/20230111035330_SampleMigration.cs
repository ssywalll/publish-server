        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankName = table.Column<string>(name: "Bank_Name", type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(name: "User_Id", type: "integer", nullable: false),
                    FoodDrinkId = table.Column<int>(name: "Food_Drink_Id", type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodDrinkMenus", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "FoodDrinkOrders",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FoodDrinkId = table.Column<int>(name: "Food_Drink_Id", type: "integer", nullable: false),
                    OrderNumber = table.Column<int>(name: "Order_Number", type: "integer", nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodDrinkOrders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Number = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<int>(name: "User_Id", type: "integer", nullable: false),
                    OrderTime = table.Column<DateTime>(name: "Order_Time", type: "timestamp without time zone", nullable: false),
                    MealDate = table.Column<DateTime>(name: "Meal_Date", type: "timestamp without time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    BankNumber = table.Column<int>(name: "Bank_Number", type: "integer", nullable: false),
                    PaymentUrl = table.Column<string>(name: "Payment_Url", type: "text", nullable: false),
